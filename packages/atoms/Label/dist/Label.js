...
var white = hsl(colors.white);
var black = hsl(colors.black);
var energy = hsl(colors.energy);
var heritage = hsl(colors.heritage);
var slate = hsl(colors.slate);
var moss = hsl(colors.moss);
var spruce = hsl(colors.spruce);
var lichen = hsl(colors.lichen);
var mist = hsl(colors.mist);

var Label = styled.label.withConfig({
  displayName: "Label",
  componentId: "sc-4r8cl2-0"
})(["display:grid;grid-gap:0.25rem;color:", ";font-weight:500;font-size:1.125rem;"], mist);
